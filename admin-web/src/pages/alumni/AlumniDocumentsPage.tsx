...
export const AlumniDocumentsPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto font-sans text-[#111111]">
      ...
      <div className="bg-gradient-to-r from-[#FFF7D6] via-amber-100/70 to-yellow-50 p-6 sm:p-8 rounded-3xl border-2 border-[#F4C542] shadow-md space-y-6 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 border-b border-amber-200/80 pb-4">
          <div className="flex items-center space-x-3.5">
            <div className="p-3 bg-[#111111] rounded-2xl text-[#F4C542]">
              <Award className="w-7 h-7" />
            </div>
            <div>
              <div className="flex items-center space-x-2">
                <h3 className="font-extrabold text-base text-[#111111]">Official Alumni Digital Membership Certificate</h3>
          ...
          <button
            ...
            className="px-4 py-2.5 bg-[#111111] text-white text-xs font-bold rounded-xl hover:bg-black flex items-center space-x-2 shadow-sm transition-all shrink-0"
          >
        ...
        <div className="flex items-center justify-between text-[11px] text-[#854D0E] font-medium pt-1">
      ...
      {showDocRequestModal && (
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <form onSubmit={handleCreateDocRequest} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl relative text-xs">
