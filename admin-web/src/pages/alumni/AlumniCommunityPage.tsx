  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto font-sans text-[#111111]">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white p-6 rounded-2xl border border-[#E5E7EB] shadow-sm">
        <div>
          <h2 className="text-xl font-bold text-[#111111]">Alumni Community & Forums</h2>
      ...
      <div className="space-y-4">
        {communityPosts.length > 0 ? (
          communityPosts.map(post => (
            <div key={post.id} className="bg-white p-6 rounded-2xl border border-[#E5E7EB] shadow-sm space-y-4">
          ...
          <div className="p-12 bg-white rounded-2xl border border-[#E5E7EB] text-center shadow-sm">
      ...
      {showCreatePostModal && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <form onSubmit={handleCreatePost} className="bg-white rounded-3xl max-w-md w-full p-6 space-y-4 shadow-2xl relative text-xs">
