  ...
  return (
    ...
    >
      <div className="space-y-6 text-[#111111] animate-fadeIn">
        ...
        <div className="relative bg-gradient-to-br from-[#111111] via-[#1A1A1A] to-[#2D2A1E] rounded-3xl p-4 sm:p-7 text-center text-white overflow-hidden shadow-xl border border-[#F4C542]/30">
          ...
          {/* Floating Badge */}
          <div className="inline-flex items-center space-x-2 bg-[#F4C542]/15 border border-[#F4C542]/40 px-3 py-1 sm:px-3.5 sm:py-1.5 rounded-full mb-3 backdrop-blur-md">
            <Sparkles className="w-3.5 h-3.5 text-[#F4C542] animate-pulse" />
            <span className="text-[10px] sm:text-[11px] font-extrabold text-[#F4C542] tracking-wider uppercase">
              {language === 'ta' ? 'விரைவில் வெளியீடு' : 'LAUNCHING SOON • OFFICIAL APP'}
            </span>
          </div>

          {/* Hero Smartphone Icon */}
          <div className="relative w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-tr from-[#F4C542] to-[#FFE899] rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-lg shadow-[#F4C542]/20 transform hover:scale-105 transition-transform">
            <Smartphone className="w-8 h-8 sm:w-9 sm:h-9 text-[#111111]" />
          ...
          <div className="mt-4 sm:mt-5 flex flex-wrap items-center justify-center gap-2.5 sm:gap-3">
            {/* Apple App Store */}
            <div className="flex items-center space-x-2 bg-white/10 backdrop-blur-md border border-white/15 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs text-gray-200">
        ...
        {/* Notify Me Form */}
        <div className="bg-[#FFF7D6]/60 border-2 border-[#F4C542]/40 rounded-2xl p-3.5 sm:p-4">
          {notified ? (
            ...
            <form onSubmit={handleNotifyMe} className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                <input
                  ...
                  className="flex-1 px-3.5 py-2.5 bg-white border border-[#F4C542]/60 rounded-xl text-xs text-[#111111] focus:outline-none focus:ring-2 focus:ring-[#F4C542] placeholder-gray-400 shadow-sm min-w-0"
                />
                <button
                  type="submit"
                  className="py-2.5 px-4 bg-[#111111] hover:bg-black text-[#F4C542] font-bold text-xs rounded-xl shadow-md transition-all flex items-center justify-center space-x-1.5 border border-[#F4C542]/40 cursor-pointer flex-shrink-0"
                >
        ...
        {/* <div className="pt-2 text-center border-t border-gray-100 flex flex-col sm:flex-row items-center justify-between gap-2">
