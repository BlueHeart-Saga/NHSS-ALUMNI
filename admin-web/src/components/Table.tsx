...
export function Table<T>({ 
  ...
  return (
    <div className="w-full border border-[#E5E7EB] rounded-2xl bg-white shadow-xs overflow-hidden">
        ...
        <table className="w-full text-left border-collapse">
          ...
          <tbody className="divide-y divide-[#E5E7EB] text-sm text-[#111111]">
            {pageData.length > 0 ? (
              ...
              <tr>
                <td colSpan={columns.length} className="px-6 py-10 text-center text-gray-400 text-xs italic">
      ...
      {showPagination && totalItems > 0 && (
        <div className="px-6 py-3 bg-[#FAFAFA] border-t border-[#E5E7EB] flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[#6B7280]">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-1.5">
              ...
              <select
                ...
                className="bg-white border border-[#E5E7EB] rounded-lg px-2 py-1 text-xs focus:outline-none focus:border-[#F4C542] text-[#111111] font-semibold"
              >
          ...
          <div className="flex items-center space-x-1.5">
            ...
            <span className="px-3 py-1 font-semibold text-[#111111] bg-white border border-[#E5E7EB] rounded-lg">
